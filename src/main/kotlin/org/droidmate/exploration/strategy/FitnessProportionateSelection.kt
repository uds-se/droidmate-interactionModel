 ...
 */
open class FitnessProportionateSelection @JvmOverloads constructor(
    randomSeed: Long,
    modelName: String = "HasModel.model",
    arffName: String = "baseModelFile.arff"
) : ModelBased(randomSeed, modelName, arffName) {
     ...
     *
     * TODO: Be careful, probably the 'suspend' has to be added to the function in the future.
     */
